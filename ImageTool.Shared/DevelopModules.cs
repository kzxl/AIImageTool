...
public static class DevelopModules
{
    ...
    public static readonly IReadOnlyList<Module> All = new List<Module>
    {
        ...
        new("detail", "Detail", ColorNoiseReductionOp.Type, LumaNoiseReductionOp.Type, ChromaDenoiseOp.Type, HotPixelOp.Type, CaCorrectOp.Type, DefringeOp.Type, ClarityOp.Type, TextureOp.Type, SharpenOp.Type),
