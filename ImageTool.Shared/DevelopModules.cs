...
public static class DevelopModules
{
    ...
    public static readonly string[] PipelineOrder =
    {
        ...
        HighlightReconstructionOp.Type,
    ...
    public static readonly IReadOnlyList<Module> All = new List<Module>
    {
        ...
        new("tonemap", "Tone Mapping", DehazeOp.Type, FilmicOp.Type, ToneEqualizerOp.Type, SigmoidOp.Type, FilmicRgbOp.Type, RgbLevelsOp.Type, HighlightReconstructionOp.Type),
