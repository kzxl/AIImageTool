...
> 343/343 test pass, build 0 warning, 3 plugin.
...
> test); D6.1 Selective paste module ✅ xong (`DevelopModules` + context menu "chọn module" + test). Còn
> D3.2 chroma denoise nâng, D6.2 style append. **ĐỢT 3:** D2.2 ICC, D3.1 diffuse, D5.x RAW thật (LibRaw),
